...
def render(obs, mode='human', close=False):
    ...
    if mode == "egocentric":
        ...
        return render_from_layout_crisp(layout, get_token_images), layout
...
def render55(obs, layout=None, mode='human', close=False):
    ...
    if mode == "egocentric":
        ...
        #return render_from_layout(obs, get_token_images), layout
        return render_from_layout_crisp(layout, get_token_images), layout
...
# def render77(obs, layout=None, mode='human', close=False):
...
#         #return render_from_layout(obs, get_token_images), layout
#         return render_from_layout_crisp(obs, get_token_images), layout
